...
public class ModelBlueGenie extends SkillsAnimatedModel<EntityAbstractGenie, IDisplayArgument> {


    public static ResourceArray TEXTURE = new ResourceArray(DesertMania.MOD_ID,"entity/genie/blue/genie_%s.png",4,1);
    public static ResourceLocation MODEL = ResourceUtils.loadModel(DesertMania.MOD_ID,"entity/genie/genie_blue.geo.json");
    public static ResourceLocation ANIMATIONS = ResourceUtils.loadAnimation(DesertMania.MOD_ID,"entity/genie/genie_blue.animation.json");

    public ModelBlueGenie() {
