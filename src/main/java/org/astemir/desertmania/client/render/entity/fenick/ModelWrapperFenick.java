...
public class ModelWrapperFenick extends SkillsWrapperEntity<EntityFenick> {

    private final ModelFenick MODEL = new ModelFenick();
    ...
    @Override
    public SkillsModel<EntityFenick, IDisplayArgument> getModel(EntityFenick entity) {
        return MODEL;
    }
}
