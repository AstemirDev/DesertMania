...
public class ModelWrapperFenickMage extends SkillsWrapperEntity<EntityFenickMage> {

    private final ModelFenickMage MODEL = new ModelFenickMage();
    ...
    @Override
    public SkillsModel<EntityFenickMage, IDisplayArgument> getModel(EntityFenickMage entity) {
        return MODEL;
    }
}
