...
public class ModelWrapperFenickFakir extends SkillsWrapperEntity<EntityFenickFakir> {

    private final ModelFenickFakir MODEL = new ModelFenickFakir();
    ...
    @Override
    public SkillsModel<EntityFenickFakir, IDisplayArgument> getModel(EntityFenickFakir entity) {
        return MODEL;
    }
}
