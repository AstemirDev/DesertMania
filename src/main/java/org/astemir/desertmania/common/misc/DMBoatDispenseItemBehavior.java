...
public class DMBoatDispenseItemBehavior extends DefaultDispenseItemBehavior{

    private final DefaultDispenseItemBehavior defaultDispenseItemBehavior = new DefaultDispenseItemBehavior();
    private final DMBoatType type;
    private final boolean isChestBoat;

    public DMBoatDispenseItemBehavior(DMBoatType p_123371_) {
        this(p_123371_, false);
    }

   public DMBoatDispenseItemBehavior(DMBoatType p_235891_, boolean p_235892_) {
        this.type = p_235891_;
    ...
    public ItemStack execute(BlockSource p_123375_, ItemStack p_123376_) {
        ...
        Boat boat = this.isChestBoat ? new EntityDMChestBoat(level, d0, d1, d2) : new EntityDMBoat(level, d0, d1, d2);
