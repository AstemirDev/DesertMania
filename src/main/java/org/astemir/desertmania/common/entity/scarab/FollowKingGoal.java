...
public class FollowKingGoal extends Goal {
    ...
    public FollowKingGoal(Mob p_25271_, double p_25272_, float p_25273_, float p_25274_) {
        this.mob = p_25271_;
    ...
    public boolean canUse() {
        List<EntityScarabLord> list = this.mob.level.getEntitiesOfClass(EntityScarabLord.class, this.mob.getBoundingBox().inflate(this.areaSize), this.followPredicate);
        if (!list.isEmpty()) {
            for(Mob mob : list) {
