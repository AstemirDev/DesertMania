...
public class ItemDMBoat extends Item {

    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final DMBoatType type;
    private final boolean hasChest;

    public ItemDMBoat(boolean hasChest, DMBoatType type, Item.Properties p_220015_) {
        super(p_220015_);
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40622_, Player p_40623_, InteractionHand p_40624_) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                ...
                ((IDMBoat)boat).setDMBoatType(this.type);
    ...
    private Boat getBoat(Level p_220017_, HitResult p_220018_) {
        return (this.hasChest ? new EntityDMChestBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) : new EntityDMBoat(p_220017_, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
}
